...
class ViewTaxFormByRepresentative extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  approve = (taxformId) => {
    this.props.history.push(`/verifyTaxformByRepresentative/${this.state.representativeId}/${taxformId}/${1}`);
  };
  reject = (taxformId) => {
    this.props.history.push(`/verifyTaxformByRepresentative/${this.state.representativeId}/${taxformId}/${2}`);
  };
...
export default ViewTaxFormByRepresentative;
