...
class AddTaxDetailsByCustomer extends Component {
  constructor(props) {
    super(props);
  ...
  saveTaxDetails = (e) => {
    ...
    AddTaxDetailsService.addTaxDetailsByCustomer(objTaxForm).then((res) => {
  ...
  getTitle() {
    return <h3 className="text-center">Add Tax Details</h3>;
  }
        ...
        {this.state.hasError && (
          <div className="row">
            <table className="table table-striped table-bordered">
              <thead>
                <tr>
                  <th> Your employer has not given TDS details yet!</th>
                </tr>
              </thead>
            </table>
...
export default AddTaxDetailsByCustomer;
