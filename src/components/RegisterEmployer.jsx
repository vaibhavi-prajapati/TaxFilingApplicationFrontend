...
class RegisterEmployer extends Component {
  ...
  saveOrUpdateEmployee = (event) => {
    ...
    RegistrationService.createEmployee(data).then((res) => {
      alert(res.data);
              ...
              <div className="card-body">
                <form onSubmit={this.saveOrUpdateEmployee}>
                  <div className="form-group">
                    ...
                    <input placeholder="Organization" name="org" className="form-control" type="text" pattern="[A-Za-z ]{2,30}" title="Must contain only characters and size should be between 2 to 30" value={this.state.organization} onChange={this.changeorgHandler} required />
                  </div>
                  <div className="form-group">
                    <label> Email: </label>
                  ...
                  <div className="form-group">
                    ...
                    <input placeholder="contact Number" name="contactNo" className="form-control" pattern="(^$|[0-9]{10})" title="contact no should be of 10 digits" type="text" value={this.state.contactNo} onChange={this.changeContHandler} required />
                  </div>
